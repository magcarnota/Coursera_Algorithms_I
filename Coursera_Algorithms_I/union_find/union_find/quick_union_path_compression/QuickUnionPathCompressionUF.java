package union_find.quick_union_path_compression;
 ...
 * ------------------------------------------------
 * lengthOfArray  |  lg(lengthOfArray) | lg(lengthOfArray)
 * 
 * (*) lg base 10
 * 
...
public class QuickUnionPathCompressionUF {
	 ...
	 * @param lengthOfArray
	 */
	public QuickUnionPathCompressionUF(int lengthOfArray) {
	 ...
	 * When we find a root we make that element point
	 * to its grandparent
